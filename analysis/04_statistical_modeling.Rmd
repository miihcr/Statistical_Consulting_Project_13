...
summary(m_cohesion_3a)
sjPlot::tab_model(m_cohesion_3a)
```
...
performance::icc(m_cohesion_3a)

performance::r2(m_cohesion_3a)
...
terms_cohesion_keep <- c(
  # 3-way interactions 
  "grouppositive_norm:blockpost:cohesion_capped_c ",
  "groupnegative_norm:blockpost:cohesion_capped_c ",
  "grouppositive_norm:targetclimate:cohesion_capped_c ",
  "groupnegative_norm:targetclimate:cohesion_capped_c ",
  "grouppositive_norm:targetprosocial:cohesion_capped_c ",
  "groupnegative_norm:targetprosocial:cohesion_capped_c ",
  "blockpost:targetclimate:cohesion_capped_c ",
  "blockpost:targetprosocial:cohesion_capped_c ",
  
  # 2-way interactions
  "grouppositive_norm:cohesion_capped_c ",
  "groupnegative_norm:cohesion_capped_c ",
  "blockpost:cohesion_capped_c ",
  "targetclimate:cohesion_capped_c ",
  "targetprosocial:cohesion_capped_c ",
...
p_cohesion_3a <- sjPlot::plot_model(
  m_cohesion_3a,
  type = "est",
...
ggsave("figures/regression-plots/m-cohesion-3a.png",
       plot = p_cohesion_3a, width = 7, height = 5, dpi = 300)
