...
# NOTE: Missingness is assessed on RAW data (before processing)
...
ggsave(p_fig("missingness", "missingness_plot.png"), missing_1, width = 7, height = 5, dpi = 300)


missing_2 <- gg_miss_var(df_wide)

ggsave(p_fig("missingness", "missingness_plot2.png"), 
...
ggsave(p_fig("missingness", "missingness_plot3.png"), 
...
ggsave(p_fig("missingness", "missingness_plot4.png"), 
